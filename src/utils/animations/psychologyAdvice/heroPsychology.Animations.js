...
export const heroPsychologyAnimations = () => {
  const kicker = document.querySelector(".hero-psychology-kicker");
  const title = document.querySelector(".hero-psychology-title");
  const tags = document.querySelector(".hero-psychology-tags");
  const subtitle = document.querySelector(".hero-psychology-subtitle");
  const ctas = document.querySelector(".hero-psychology-ctas");
  const microcopy = document.querySelector(".hero-psychology-microcopy");
  const image = document.querySelector(".hero-psychology-image");
  const badge = document.querySelector(".hero-psychology-badge");
